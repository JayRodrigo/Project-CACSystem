 ...
 * @author User
 */
public class AvailableEmployees extends javax.swing.JFrame {
    private int row;
    /**
    ...
    public AvailableEmployees() {
        ...
        PredefineMethods.tableload("SELECT epfNo,fname,lname,phone,user_level FROM employee WHERE availability='Available'", aEmpList);   
    }
    ...
    private void initComponents() {
        ...
        aEmpList = new javax.swing.JTable();
        ...
        emp.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        emp.setText("Available Employees");
        jPanel3.add(emp, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 80, 330, -1));

        aEmpList.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        aEmpList.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                aEmpListMouseClicked(evt);
            }
        });
        jScrollPane5.setViewportView(aEmpList);

        jPanel3.add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 140, 810, 270));
    ...
    private void aEmpListMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_aEmpListMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_aEmpListMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AvailableEmployees.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable aEmpList;
