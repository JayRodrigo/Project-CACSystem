 ...
 * @author User
 */
public class UpdatePlant extends javax.swing.JFrame {

    /**
     * Creates new form AddTools
     */
    public UpdatePlant(String updateID,String updateName,String updateType,String updateQuantity,String updateApperDate,String updateNotes) throws SQLException, ParseException {
        initComponents();
        id.setText(updateID);
    ...
    private void initComponents() {
        ...
        submit.setText("Update Plant Details");
        ...
        jLabel1.setText("Update Plant Details");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 260, 30));
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        String qry = "Update plant SET "
                    ...
                    + "appear = '"+PredefineMethods.getSelectedDate(plantFA)+"',"
                    + "Note = '"+jTextArea1.getText().toString()+"' "
                    + "where plant_id = '"+id.getText()+"'";
                
        PredefineMethods.editDB(qry);
        PredefineMethods.viewJoptionPane("Plant Successfully Updated");
