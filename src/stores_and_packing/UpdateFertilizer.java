...
public class UpdateFertilizer extends javax.swing.JFrame {
     ...
     */
    public UpdateFertilizer(String updateID,String updateName,String updateType,String updateQuantity,String updateApperDate,String updateNotes) throws SQLException, ParseException {
        initComponents();
        id.setText(updateID);
    ...
    private void initComponents() {
        ...
        fertilizerFA = new com.toedter.calendar.JDateChooser();
        ...
        submit.setText("Update Fertilizer Details");
        ...
        jLabel1.setText("Update Fertilizer Details");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 310, 30));
        ...
        getContentPane().add(fertilizerFA, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 260, 180, -1));
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
            String qry = "Update fertilizer SET "
                    ...
                    + "appear = '"+PredefineMethods.getSelectedDate(fertilizerFA)+"',"
                    + "Note = '"+jTextArea1.getText().toString()+"' "
                    + "where fertilizer_id = '"+id.getText()+"'";
            PredefineMethods.editDB(qry);
            PredefineMethods.viewJoptionPane("Fertilizer Successfully Updated");
    ...
    private com.toedter.calendar.JDateChooser fertilizerFA;
