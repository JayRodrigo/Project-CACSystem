 ...
 * @author User
 */
public class UpdateChemical extends javax.swing.JFrame {

    /**
     * Creates new form AddTools
     */
    public UpdateChemical(String updateID,String updateName,String updateType,String updateQuantity,String updateApperDate,String updateNotes) throws SQLException, ParseException {
        initComponents();
        id.setText(updateID);
        PredefineMethods.setTextField(toname, updateName);
        PredefineMethods.setComboBox(typet, updateType);
        PredefineMethods.setTextField(qua, updateQuantity);
        java.util.Date dateAD = new SimpleDateFormat("EEEE, MMMM dd, yyyy").parse(updateApperDate);
        chemicalFA.setDate(dateAD);
        jTextArea1.setText(updateNotes);
    }
    ...
    private void initComponents() {
        ...
        chemicalFA = new com.toedter.calendar.JDateChooser();
        ...
        submit.setText("Update Chemical Details");
        ...
        jLabel1.setText("Update Chemical Details");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 370, 30));
        ...
        getContentPane().add(chemicalFA, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 260, 180, -1));
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        String qry = "Update chemical SET "
                    + "name = '"+PredefineMethods.getTextField(toname)+"',"
                    + "type = '"+PredefineMethods.getSelectedCombo(typet)+"',"
                    + "quantity = '"+PredefineMethods.getTextField(qua)+"',"
                    + "appear = '"+PredefineMethods.getSelectedDate(chemicalFA)+"',"
                    + "Note = '"+jTextArea1.getText().toString()+"' "
                    + "where chemical_id = '"+id.getText()+"'";
        
        PredefineMethods.editDB(qry);
        PredefineMethods.viewJoptionPane("Chemical Successfully Upadted");
    ...
    private com.toedter.calendar.JDateChooser chemicalFA;
