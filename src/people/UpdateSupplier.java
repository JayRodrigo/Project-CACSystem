...
public class UpdateSupplier extends javax.swing.JFrame {
     ...
     */
    public UpdateSupplier(String updateID,String updateName,String updateEmail,String updatePhone,String updateCompany,String updateAddress,String updateCity,String updateState,String updatePostalCode,String updateCountry) throws SQLException {
        initComponents();
        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);

        supplierID.setText(updateID);
        PredefineMethods.setTextField(name, updateName);
        PredefineMethods.setTextField(email, updateEmail);
        PredefineMethods.setTextField(phone, updatePhone);
        PredefineMethods.setTextField(company, updateCompany);
        ...
        PredefineMethods.setTextField(country, updateCountry);
    }
    ...
    private void addCustomer1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addCustomer1ActionPerformed
        ...
        }else
        {
            String qry = "Update supplier SET "
                    + "name = '"+PredefineMethods.getTextField(name)+"',"
                    + "email = '"+PredefineMethods.getTextField(email)+"',"
                    + "phone = '"+PredefineMethods.getTextField(phone)+"',"
                    + "company = '"+PredefineMethods.getTextField(company)+"',"
                    ...
                    + "country = '"+PredefineMethods.getTextField(country)+"' "
                    + "where supplier_id = '"+supplierID.getText()+"'";
            PredefineMethods.editDB(qry);
            PredefineMethods.viewJoptionPane("Supplier Successfully Updated");           
