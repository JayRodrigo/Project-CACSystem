...
public class UpdateCustomer extends javax.swing.JFrame {
     ...
     */
    public UpdateCustomer(String updateID,String updateCompany,String updateEmail,String updatePhone,String updateAddress,String updateCity,String updateBillingAddress,String updateBillingAddress1,String updateBillingAddress2,String updateBillingAddress3,String updateState,String updatePostalCode,String updateVatNo,String updateSvatNo) throws SQLException {
        initComponents();
        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        
        customerID.setText(updateID);
        PredefineMethods.setTextField(name, updateCompany);
        ...
        PredefineMethods.setTextField(city, updateCity);
        PredefineMethods.setTextField(bAddress, updateBillingAddress);
        PredefineMethods.setTextField(bAddress1, updateBillingAddress1);
        PredefineMethods.setTextField(bAddress2, updateBillingAddress2);
        PredefineMethods.setTextField(bAddress3, updateBillingAddress3);
        PredefineMethods.setTextField(state, updateState);
        PredefineMethods.setTextField(pCode, updatePostalCode);
        PredefineMethods.setTextField(vatNo, updateVatNo);
        PredefineMethods.setTextField(svatNo, updateSvatNo);
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(addCustomer, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(Cancel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(44, 44, 44))
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
    ...
    private void addCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addCustomerActionPerformed
        ...
        else
        {
             String qry = "Update customer SET "
                    + "company = '"+PredefineMethods.getTextField(name)+"',"
                    ...
                    + "city = '"+PredefineMethods.getTextField(city)+"',"
                    + "billing_address = '"+PredefineMethods.getTextField(bAddress)+"',"
                    + "billing_address1 = '"+PredefineMethods.getTextField(bAddress1)+"',"
                    + "billing_address2 = '"+PredefineMethods.getTextField(bAddress2)+"',"
                    + "billing_address3 = '"+PredefineMethods.getTextField(bAddress3)+"',"
                    + "state = '"+PredefineMethods.getTextField(state)+"',"
                    + "postal_code = '"+PredefineMethods.getTextField(pCode)+"',"
                    + "vat_no = '"+PredefineMethods.getTextField(vatNo)+"',"
                    + "svat_no = '"+PredefineMethods.getTextField(svatNo)+"' "
                    + "where customer_id = '"+customerID.getText()+"'";
            
            PredefineMethods.editDB(qry);
            PredefineMethods.viewJoptionPane("Customer Successfully Updated");
