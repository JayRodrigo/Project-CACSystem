 ...
 * @author User
 */
public class ViewChemicalRecipies extends javax.swing.JFrame {
    private int row;
    /**
     * Creates new form ViewTools
     */
    public ViewChemicalRecipies() throws SQLException {
        initComponents();
        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        PredefineMethods.tableload("Select recipe_id, name from chemical_recipe", jtabmachine);
        id.setText(Integer.toString((Integer.parseInt(PredefineMethods.
                        viewDBValue("SELECT MAX(recipe_id) as last_recipe_id FROM chemical_recipe", "last_recipe_id")))+1));
    }
    
    public String getNoteValue(String id) throws SQLException{
        String qry = "Select Recipe from chemical_recipe where recipe_id = '"+id+"'";
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Chemical Recipies");
        ...
        jLabel4.setText("Chemical Recipe ID :");
    ...
    private void printActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printActionPerformed
        String file = "chemical_recipe"+new PredefineMethods().generate4Digits()+".pdf";
        String cur_dir = System.getProperty("user.dir");
        String filePath = cur_dir+"\\output\\"+file;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       String qry = "INSERT INTO chemical_recipe (name, Recipe) "
               + "VALUES ('"+PredefineMethods.getTextField(name)+"',"
               + "'"+jTextArea1.getText().toString()+"')";
       
       PredefineMethods.editDB(qry);
       PredefineMethods.viewJoptionPane("Chemical Recipe Successfully Added");
       PredefineMethods.tableload("Select recipe_id, name from chemical_recipe", jtabmachine);  
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
       String qry = "Update chemical_recipe SET name = '"+PredefineMethods.getTextField(name)+"',"
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        String qry = "DELETE from chemical_recipe where recipe_id = '"+id.getText().toString()+"'";
               PredefineMethods.editDB(qry);
               PredefineMethods.tableload("Select recipe_id, name from chemical_recipe", jtabmachine);  
    ...
    private void jtabmachineMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtabmachineMouseClicked
        ...
        try {
            ...
            Logger.getLogger(ViewChemicalRecipies.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_jtabmachineMouseClicked

    private void searchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchKeyReleased
          if(!search.getText().toString().equals("")){
            PredefineMethods.tableload("Select recipe_id, name from chemical_recipe where recipe_id = '"+search.getText().toString()+"'", jtabmachine);
        }else{
            PredefineMethods.tableload("Select recipe_id, name from chemical_recipe", jtabmachine);  
        }  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewChemicalRecipies.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
