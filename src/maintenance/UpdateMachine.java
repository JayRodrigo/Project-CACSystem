...
public class UpdateMachine extends javax.swing.JFrame {

    /**
     * Creates new form AddMachine
     */
    public UpdateMachine(String updateID,String updateName,String updateManufacturer,String updateDOP,String updateDepartment,String updateStatus) throws SQLException, ParseException {
        initComponents();
        machrefno.setText(updateID);
        PredefineMethods.setTextField(machname, updateName);
        PredefineMethods.setComboBox(manu, updateManufacturer);
        PredefineMethods.setComboBox(dept, updateDepartment);
        PredefineMethods.setComboBox(stat, updateStatus);
        java.util.Date dateDOP = new SimpleDateFormat("EEEE, MMMM dd, yyyy").parse(updateDOP);
        machineDOP.setDate(dateDOP);
    ...
    private void initComponents() {
        ...
        btnEdit.setText("Update Machine");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(machineDOP, javax.swing.GroupLayout.PREFERRED_SIZE, 178, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
               ...
               String qry = "Update machine SET "
                    + "name = '"+PredefineMethods.getTextField(machname)+"',"
                    + "manufacturer = '"+PredefineMethods.getSelectedCombo(manu)+"',"
                    + "date_of_purchase = '"+PredefineMethods.getSelectedDate(machineDOP)+"',"
                    + "department = '"+PredefineMethods.getSelectedCombo(dept)+"',"
                    + "status = '"+PredefineMethods.getSelectedCombo(stat)+"' "
                    + "where machine_ref_no = '"+machrefno.getText()+"'";
            PredefineMethods.editDB(qry);
            PredefineMethods.viewJoptionPane("Machine Successfully Updated");            
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateMachine.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
