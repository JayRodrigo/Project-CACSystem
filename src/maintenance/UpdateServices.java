...
public class UpdateServices extends javax.swing.JFrame {
    ...
    public UpdateServices(String updateServiceID,String updateMachineRefNo,String updateType,String updateEquipName,String updateDOS) throws SQLException, ParseException {
        ...
        PredefineMethods.setTextField(equiname, updateEquipName);
        java.util.Date dateDOS = new SimpleDateFormat("EEEE, MMMM dd, yyyy").parse(updateDOS);
        serviceDOS.setDate(dateDOS);
    }
    ...
    private void initComponents() {
        ...
        serviceDOS = new com.toedter.calendar.JDateChooser();
        ...
        submit.setText("Update Service Details");
        ...
        jLabel1.setText("Update Service Details");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(181, 181, 181)
                        .addComponent(serviceDOS, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(serviceDOS, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(42, 42, 42)
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        String qry = "Update service SET "
                    + "machine_ref_no = '"+PredefineMethods.getSelectedCombo(machrefno)+"',"
                    + "type = '"+PredefineMethods.getSelectedCombo(types)+"',"
                    + "equipment_name = '"+PredefineMethods.getTextField(equiname)+"',"
                    + "date_of_service = '"+PredefineMethods.getSelectedDate(serviceDOS)+"' "
                    + "where service_no = '"+serno.getText()+"'";
            PredefineMethods.editDB(qry);
            PredefineMethods.viewJoptionPane("Service Successfully Updated");
    ...
    private com.toedter.calendar.JDateChooser serviceDOS;
